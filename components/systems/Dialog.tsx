      ...
      <Transition.Root show={open}>
        ...
        >
          ...
          >
            ...
            >
              <XIcon className='size-4 text-neutral-500 hover:text-neutral-700 dark:text-neutral-500 dark:hover:text-neutral-400' />
            </DialogRadix.Close>

            <div className={twMerge('p-5', showIcon && 'sm:flex sm:gap-4')}>
              {showIcon ? (
                isDanger ? (
                  <div className='mx-auto flex size-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0'>
                    <AlertTriangleIcon className='size-6 text-red-600' aria-hidden='true' />
                  </div>
                ) : (
                  <div className='mx-auto flex size-12 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 sm:mx-0'>
