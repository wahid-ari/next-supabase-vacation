...
export default function FrontTabs({ children, className, items, ...props }: Props) {
  return (
    <Tab.Group>
      ...
      >
        <div className='scrollbar-thumb-rounded flex gap-x-6 overflow-x-auto px-1 py-2 scrollbar-thin scrollbar-thumb-neutral-200 sm:gap-x-8 dark:scrollbar-thumb-neutral-800'>
